    ...
    <div className="l-constrainer">
      <div className="o-footer__sections">
        <FooterSection title={footerData.quicklinks.title}>
          <LinkList links={footerData.quicklinks.links} linkClasses={['a-link--footer']} />
        </FooterSection>
        <FooterSection title={footerData.about.title}>
          <LinkList links={footerData.about.links} linkClasses={['a-link--footer']} />
        </FooterSection>
      ...
      <div className="o-footer__bottom">
        <LinkList links={[{ label: 'Impressum', url: '#' }, { label: 'Datenschutz', url: '#' }]} linkClasses={['a-link--footer']} />
